...
INSERT INTO STUDENTS (first_name, last_name, email, password, date_of_birth, profile_id) VALUES ('John', 'Smith', 'john.smith@gmail.com', 'password', '1987-08-14', 1);

INSERT INTO LEARNER_PROFILES (number_of_credits, gpa, is_graduated, start_year) VALUES (25, 68.1, 'FALSE', 2021);
INSERT INTO STUDENTS (first_name, last_name, email, password, date_of_birth, profile_id) VALUES ('Mary', 'James', 'mary.james@gmail.com', 'password', '2002-12-02', 2);

INSERT INTO LEARNER_PROFILES (number_of_credits, gpa, is_graduated, start_year) VALUES (140, 88, 'FALSE', 2021);
INSERT INTO STUDENTS (first_name, last_name, email, password, date_of_birth, profile_id) VALUES ('Dianna', 'Martin', 'dianna.martin@yahoo.com', 'password', '2001-01-03', 3);

INSERT INTO LEARNER_PROFILES (number_of_credits, gpa, is_graduated, start_year) VALUES (87, 74.5, 'TRUE', 2019);
INSERT INTO STUDENTS (first_name, last_name, email, password, date_of_birth, profile_id) VALUES ('Daniel', 'Lee', 'daniel.lee@yahoo.com', 'password', '1999-04-05', 4);
